...
| macOS（Apple 芯片 / arm64） | [下载 Codex-ZH 中文版 0.5.1 macOS arm64 安装包](https://github.com/focuxdot/codex-zh/releases/download/v0.5.1/Codex-ZH-0.5.1-mac-arm64.dmg) |
| macOS（Intel / x64，macOS 12+） | [下载 Codex-ZH 中文版 0.5.1 macOS Intel x64 安装包](https://github.com/focuxdot/codex-zh/releases/download/v0.5.1/Codex-ZH-0.5.1-mac-x64.dmg) |
