...
2. 首次打开如果提示“已损坏”或“无法验证开发者”，打开「终端」执行一次 `xattr -dr com.apple.quarantine /Applications/Codex-ZH.app` 即可（原因和图形界面办法见常见问题）。
...
- **终端法（最稳）**：打开「终端」执行 `xattr -dr com.apple.quarantine /Applications/Codex-ZH.app`，之后正常双击打开。
